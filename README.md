...
Follow [these instructions](https://bitbucket.org/udg_cirs/turtlebot_online_path_planning/src/master/docs/ompl.md) for the procedure.# Minigirona-Path-Planning
